...
public abstract class NGraphics {
    ...
    public final void drawString(String s, NPoint point) {
    ...
    public final NGraphics create(NPoint point, NDimension size) {
        return create(point.x, point.y, size.w, size.h);
    }

    public final NGraphics create(NRectangle bounds) {
    ...
    public final void drawImage(NImage img, NRectangle bounds) {
    ...
    public final void drawImage(NImage img, NRectangle srcArea, NRectangle dstArea) {
